...
export const ALL_PROJECTS = [
...

  {
    ...
    description:
      'Built a full-stack EdTech platform at sturdee.online with user auth, an admin dashboard, session booking, and an integrated tutorial site — courses, programs, learning paths, and instructor profiles in a premium editorial UI.',
    tags: ['Next.js', 'React', 'Auth', 'Admin Dashboard', 'Booking'],
    image: '/images/sturdee.png',
    link: 'https://sturdee.online',
    detailPage: '/sturdee',
    tagline:
      'A premium education platform with auth, admin controls, booking, and a built-in tutorial experience — live at sturdee.online.',
    ...
    solution: {
      heading: 'Full-Stack EdTech Platform With Auth, Admin, Booking & Tutorials',
      summary:
        'I built sturdee.online end-to-end on Next.js — a public-facing tutorial and course site with Sign Up / Login auth, a Book flow for scheduling sessions, structured learning paths across Web Development, Programming, and Blockchain, and a secure admin dashboard for managing the entire platform.',
      features: [
        {
...

  {
    ...
    description:
      'Built a full-stack corporate site for PT Inema Konstruksi with user auth, an admin dashboard, and a project booking/inquiry system — plus editorial dark-mode design, landmark portfolio, and service capability showcase.',
    tags: ['Next.js', 'React', 'Auth', 'Admin Dashboard', 'Booking'],
    image: '/images/inema.png',
    link: 'https://inema.site',
    detailPage: '/inema',
    tagline:
      'A world-class construction brand site with auth, admin controls, and project booking — live at inema.site.',
    ...
    solution: {
      heading: 'Editorial Construction Brand Site Built End-to-End',
      summary:
        'I designed and built inema.site end-to-end — a premium dark-mode corporate experience with Sign Up / Login auth, a Get Quote booking flow, a secure admin dashboard for managing inquiries and site content, plus phased hero storytelling, landmark portfolio, and full service capability grid.',
      features: [
        {

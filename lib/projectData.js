...
export const ALL_PROJECTS = [
  {
    ...
    description:
      'Built a luxury automotive Shopify storefront with a fully functional admin experience. The owner can edit page content, manage vehicle inventory, add pages, and control site settings without touching code.',
    tags: ['Shopify', 'Liquid', 'E-commerce', 'Automotive'],
    image: '/images/oreo (2).png',
    link: 'https://oreo.ink',
    detailPage: '/oreo',
    tagline:
      'A fully content-managed luxury automotive Shopify store built for zero developer dependency.',
    heroImage: '/images/oreo (2).png',
    images: ['/images/oreo (3).png', '/images/oreo (4).png'],
    overview: {
      type: 'Shopify / Luxury Automotive',
      duration: '3 Weeks',
    ...
    solution: {
      heading: 'Custom Shopify Dealership Storefront',
      summary:
        'I built a polished Shopify storefront with custom Liquid sections and a fully custom admin experience that gives the owner complete control over every part of the site — no code, no developers, no blockers.',
      features: [
        {
          title: 'Shopify Content Management',
          description:
            'All page content, hero text, banners, and about sections are editable through the Shopify admin in real time.',
          icon: 'database',
        },
        {
...

  {
    ...
    description:
      'Built a custom Shopify DTC sneaker storefront for Yowaa — premium authentic Yeezy, Nike & Adidas sourced direct with no retail markup. Features featured drops, shop-by-style collections, pre-order flows, authenticity guarantee, and member email capture.',
    ...
    challenge: {
      ...
      summary:
        'Yowaa needed a DTC storefront that communicated trust, authenticity, and better pricing than retail — without looking like a generic dropshipping template. Customers had to feel confident buying premium Yeezy, Nike, and Adidas pairs online.',
      points: [
    ...
    solution: {
      ...
      summary:
        'I designed and built the Yowaa Shopify theme end-to-end — a bold DTC experience with a "Direct to you. No markup." hero, featured pairs grid, shop-by-style collections, authenticity inspection section, pre-order drop support, and drops-list email capture.',
      features: [
        {
    ...
    impact: {
      ...
      points: [
        'Live at yowaa-2.myshopify.com — taking orders with Shopify checkout',
...

  {
    ...
    title: 'Yanga Beauty',
    description:
      'Built a premium Shopify beauty marketplace for Yanga — French pharmacy, K-beauty, luxury skincare, hair, and makeup brands with mega-menu navigation, promotional carousels, brand-of-the-month features, customer reviews, and newsletter capture.',
    ...
    challenge: {
      ...
      summary:
        'Yanga stocks dozens of brands across French pharmacy, K-beauty, luxury, hair, and makeup — but needed a storefront that felt curated and premium, not like a cluttered catalog. Promotions, new arrivals, and brand storytelling had to coexist without overwhelming shoppers.',
      points: [
    ...
    solution: {
      ...
      summary:
        'I built the Yanga Shopify theme with a mega-menu organized by brand category (French Pharmacy, Luxury & Prestige, K-Beauty, Hair, Makeup, Body & Sun), promotional hero carousels, Brand of the Month spotlight, multiple product carousels (New & Trending, Best Deals, This Week Only), and a customer review slider.',
      features: [
        {
        ...
        },
        {
          ...
          description:
            'Rotating banners for Prime Deals (up to 50% off), New Arrivals, YANGA Brand of the Month, and Summer Store promotions — each with dedicated CTAs.',
          icon: 'star',
        },
        {
        ...
        },
        {
          ...
          description:
            'Featuring right now grid — YANGA Herbal Lotion, Summer Essentials, Radiant Skin Ritual, Pharmacy Favorites — each with editorial copy and shop links.',
          icon: 'book',
        },
        {
    ...
    impact: {
      ...
      points: [
        'Live at yanga-7885.myshopify.com — full Shopify checkout and accounts',

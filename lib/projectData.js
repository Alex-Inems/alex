...
export const ALL_PROJECTS = [
...

  {
    ...
    description:
      'Built a premium motorcycle tour website for Inkamoto Tours, a Peru-based road trip operator offering guided moto and 4x4 circuits across the Andes, Machu Picchu, and the Amazon. Features tour package pages, bike rental options, multilingual navigation, FAQ, testimonials, team profiles, and contact lead capture.',
    tags: ['Webflow', 'CMS', 'Travel', 'Multilingual'],
    image: '/images/inkamoto.png',
    link: 'https://www.inkamototours.com',
    detailPage: '/inkamoto',
    tagline:
      'Exceptional Peru motorcycle road trips, from the Andes to Machu Picchu, built to convert adventure riders.',
    heroImage: '/images/inkamoto.png',
    images: ['/images/inkamoto.png', '/images/inkamoto-tours.png'],
    overview: {
      type: 'Travel / Tourism',
      duration: '3 Weeks',
    ...
    challenge: {
      heading: 'An Adventure Brand With No Digital Home for High-Intent Riders',
      summary:
        'Inkamoto Tours needed a site that matched the scale of their Peru motorcycle experiences. Riders had to understand three distinct tour packages, rental vs. turnkey options, bike fleet specs, and booking requirements, all in French, English, and Spanish, without feeling like a generic travel template.',
      points: [
        'No clear presentation of three flagship tours (Chemin des Incas, Nord, Sol de Oro)',
        'Rental, custom itinerary, and turnkey formulas were not differentiated for buyers',
        'Multilingual audience (FR/EN/ES) needed seamless language switching',
        'Social proof and FAQ content were buried, slowing conversion for international riders',
      ],
    },
    solution: {
      heading: 'Immersive Tour Marketing Site Built for Conversion',
      summary:
        'I designed and built inkamototours.com end to end, a cinematic adventure brand experience with hero storytelling, three tour package showcases, bike fleet grid (Yamaha Ténéré 700, Kawasaki KLR 650, Honda Africa Twin, Royal Enfield Himalayan 450), formula comparison cards, FAQ accordion, testimonial carousel, team section, and a contact form wired for lead capture.',
      features: [
        {
          title: 'Cinematic Hero & Brand Story',
          description:
            'Full-bleed Andean landscape hero with "Le meilleur du Pérou à moto" positioning, roadbook download CTA, and motorcycle model badges that set premium adventure expectations immediately.',
          icon: 'star',
        },
        {
          title: 'Three Flagship Tour Packages',
          description:
            'Dedicated showcases for Chemin des Incas, Nord (summits to Amazon), and Sol de Oro VIP routes, each with highlights like Machu Picchu, Cordillera Blanca, and luxury hospitality tiers.',
          icon: 'layout',
        },
        {
          title: 'Rental & Turnkey Formulas',
          description:
            'Three-path conversion funnel: rent bikes for your group, trace a custom itinerary, or book all-inclusive turnkey tours with accommodation and support included.',
          icon: 'bolt',
        },
        {
          title: 'Fleet Showcase',
          description:
            'Visual grid of enduro-trail motorcycles with model names and personality tags (Intrépide, Fiable, Robuste, Aventurière) so riders know exactly what they will ride.',
          icon: 'settings',
        },
        {
          title: 'Multilingual Navigation',
          description:
            'French, English, and Spanish language switcher with localized navigation for circuits, rentals, departures, rider guide, and reviews.',
          icon: 'book',
        },
        {
          title: 'Trust & Lead Capture',
          description:
            'FAQ accordion covering experience requirements, inclusions, group vs. solo travel, and documents. Testimonial carousel with 4.7/5 rating plus contact form for tour inquiries.',
          icon: 'shield',
        },
      ],
    },
    impact: {
      heading: 'A Live Adventure Brand That Sells the Experience',
      metrics: [
        { value: '3', label: 'Flagship tour packages' },
        { value: '4', label: 'Motorcycle models showcased' },
        { value: '3', label: 'Languages supported' },
        { value: 'Live', label: 'At inkamototours.com' },
      ],
      points: [
        'Live at inkamototours.com with tour, rental, and contact flows fully operational',
        'Three tour packages clearly differentiated for international adventure riders',
        'Multilingual FR/EN/ES navigation expands reach across European and Latin American markets',
        'FAQ and testimonials reduce pre-booking friction for high-ticket motorcycle tours',
        'Roadbook download CTA captures leads before riders are ready to book',
        'Team section humanizes the brand with founder Jorge and on-ground guides',
      ],
    },
  },
];

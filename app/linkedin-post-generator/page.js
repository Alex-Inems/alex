...
export const metadata = {
  ...
  description:
    'n8n automation that generates professional LinkedIn posts via GPT, logs to Google Sheets, emails the admin, and returns results instantly to a Next.js UI.',
};

...
const FaqSection = () => {
  ...
  const faqs = [
    {
      question: "What kind of full-stack products do you build?",
      answer: "I build end-to-end web applications, SaaS platforms, admin dashboards, auth systems, booking flows, ticketing systems, and content platforms. Recent builds include Blogme (multi-user blogging SaaS), Eventie (ticketing with Paystack and QR verification), Inema (corporate site with booking), and Sturdee (EdTech with session booking). I handle frontend, backend, database, and deployment."
    },
    {
      question: "Why should I work with you instead of a traditional agency?",
      answer: "When you work with me, you bypass middle management, sales reps, and corporate overhead. You deal directly with a senior full-stack developer. This direct pipeline guarantees transparent communication, rapid iteration speeds, and custom, premium-grade code built to your exact specifications."
    },
    {
      question: "Do you build custom Shopify stores?",
      answer: "Yes, I also build custom Shopify storefronts with theme development, collection architecture, product page design, and checkout optimisation. Recent builds include Oreo (footwear), Yangaa (beauty), and Aurum & Co. (luxury jewelry)."
    },
    {
      question: "Do you build custom AI automation and Python agent pipelines?",
      answer: "Yes, I design n8n workflows that connect webhooks, LLM classifiers, Google Sheets, Gmail, Slack, and CRM tools. I also build autonomous LLM agents (using CrewAI and LangChain), Python data scrapers, and API integrations, embedding AI directly into your Next.js app or running them as background automations that save your business hundreds of hours."
    },
    {
      question: "Do you build n8n workflows and webhook integrations?",
      answer: "Yes, I build end-to-end automations with n8n cloud or self-hosted instances, wired to Next.js webhook endpoints, OpenAI/GPT nodes, Google Sheets logging, Gmail notifications, and custom admin dashboards. Recent builds include an AI leads classifier and a LinkedIn post generator, both with instant frontend responses and background task processing."
    },
    {
    ...
    },
    {
      ...
      answer: "I specialize in React and Next.js (App Router) for blazingly fast, SEO-optimized frontends. For backends, database, and automation pipelines, I implement secure Node.js APIs, n8n workflow orchestration, Python services, MongoDB, PostgreSQL, Shopify/Liquid, and serverless tools like Supabase and Firebase."
    },
    {
